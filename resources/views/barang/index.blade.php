...
<table class="table table-bordered table-dark" id="barangTable">
  <thead><tr><th>ID</th><th>Nama</th><th>Jumlah</th><th>Keterangan</th><th>Owner</th><th>Aksi</th></tr></thead>
  <tbody>
    ...
    <tr>
      ...
      <td>
        @php $role = session('role'); $userId = session('user_id'); @endphp
